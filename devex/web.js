...
var $;
(function ($) {
    class $koplenov_devex extends $mol_page {
        title() {
            return "asd";
        }
        tools() {
        ...
        selectFirstDate() {
            const obj = new this.$.$mol_date();
            obj.value_moment = (val) => this.today(val);
            return obj;
        }
        row1() {
        ...
        row2() {
            ...
            obj.sub = () => [
                this.secondLabel(),
                this.selectSecondDate()
            ];
            return obj;
        }
        greet_message() {
            return this.$.$mol_locale.text('$koplenov_devex_greet_message');
        }
        greet_message2() {
            return this.$.$mol_locale.text('$koplenov_devex_greet_message2');
        }
        Greeter() {
            const obj = new this.$.$mol_card();
            obj.title = () => this.$.$mol_locale.text('$koplenov_devex_Greeter_title');
            obj.content = () => [
                this.greet_message(),
                this.greet_message2()
            ];
        ...
        quest_message() {
            return this.$.$mol_locale.text('$koplenov_devex_quest_message');
        }
        Quester() {
            const obj = new this.$.$mol_card();
            obj.title = () => this.$.$mol_locale.text('$koplenov_devex_Quester_title');
            obj.content = () => [
                this.quest_message()
            ];
            return obj;
        ...
        command_message() {
            return this.$.$mol_locale.text('$koplenov_devex_command_message');
        }
        Commander() {
            const obj = new this.$.$mol_card();
            obj.title = () => this.$.$mol_locale.text('$koplenov_devex_Commander_title');
            obj.content = () => [
        ...
        result() {
            const obj = new this.$.$mol_text();
            obj.text = (val) => this.resultFetch(val);
            return obj;
        }
    }
    __decorate([
        $mol_mem
    ], $koplenov_devex.prototype, "first2", null);
    __decorate([
        $mol_mem
    ], $koplenov_devex.prototype, "second", null);
    __decorate([
        $mol_mem
    ], $koplenov_devex.prototype, "firstLabel", null);
    __decorate([
        $mol_mem
    ], $koplenov_devex.prototype, "today", null);
    __decorate([
        $mol_mem
    ], $koplenov_devex.prototype, "selectFirstDate", null);
    __decorate([
        $mol_mem
    ], $koplenov_devex.prototype, "row1", null);
    __decorate([
        $mol_mem
    ], $koplenov_devex.prototype, "secondLabel", null);
    __decorate([
        $mol_mem
    ], $koplenov_devex.prototype, "selectSecondDate", null);
    __decorate([
        $mol_mem
    ], $koplenov_devex.prototype, "row2", null);
    __decorate([
        $mol_mem
    ], $koplenov_devex.prototype, "Greeter", null);
    __decorate([
        $mol_mem
    ], $koplenov_devex.prototype, "Quester", null);
    __decorate([
        $mol_mem
    ], $koplenov_devex.prototype, "Commander", null);
    __decorate([
        $mol_mem
    ], $koplenov_devex.prototype, "Deck", null);
    __decorate([
        $mol_mem
    ], $koplenov_devex.prototype, "event_submit", null);
    __decorate([
        $mol_mem
    ], $koplenov_devex.prototype, "fetchBtn", null);
    __decorate([
        $mol_mem
    ], $koplenov_devex.prototype, "result", null);
    $.$koplenov_devex = $koplenov_devex;
})($ || ($ = {}));
//koplenov/devex/-view.tree/devex.view.tree.ts
;
"use strict";
var $;
(function ($) {
    $mol_style_attach("koplenov/devex/devex.view.css", "[koplenov_devex_row1_selectFirstDate] {\n\tz-index: 1;\n}\n");
})($ || ($ = {}));
//koplenov/devex/-css/devex.view.css.ts
;
"use strict";
var $;
(function ($) {
    var $$;
    (function ($$) {
        class $koplenov_devex extends $.$koplenov_devex {
            result() {
                const obj = new this.$.$mol_text();
                obj.text = () => this.resultFetch();
                return obj;
            }
            resultFetch(val) {
                if (val !== undefined)
            ...
            selectFirstDate() {
                const obj = new this.$.$mol_date();
                obj.value_moment = (val) => this.today(val);
                this.firstLabel().text = () => "Дата начала:";
                return obj;
            }
            selectSecondDate() {
                const obj = new this.$.$mol_date();
                obj.value_moment = (val) => this.today(val);
                this.secondLabel().text = () => "Дата окончания:";
                return obj;
            }
            event_submit(val) {
                const uri = `https://api.github.com/repos/nin-jin/HabHub/issues/7`;
                const resp = this.$.$mol_fetch.json(uri);
                this.resultFetch(resp.body);
            }
        }
        __decorate([
            $mol_mem
        ...
        __decorate([
            $mol_mem
        ], $koplenov_devex.prototype, "resultFetch", null);
        __decorate([
            $mol_mem
        ], $koplenov_devex.prototype, "selectFirstDate", null);
        __decorate([
