...
(function ($) {
    ...
    __decorate([
        $mol_action
    ], $mol_browser, "strip_scripts", null);
    __decorate([
        $mol_wire_method
...
var $;
(function ($) {
    class $koplenov_rss extends $mol_page {
        title() {
            return "metarhia";
        }
        body() {
    ...
    __decorate([
        $mol_mem_key
    ], $koplenov_rss.prototype, "Item", null);
    __decorate([
        $mol_mem
    ], $koplenov_rss.prototype, "Items", null);
    $.$koplenov_rss = $koplenov_rss;
})($ || ($ = {}));
//koplenov/rss/-view.tree/rss.view.tree.ts
;
"use strict";
var $;
(function ($) {
    ...
    (function ($$) {
        ...
        if (port) {
            const context = $.$mol_ambient({
                $mol_browser: new $mol_browser
            });
            const obj = {};
            obj.$ = context;
            console.log(obj.$.$mol_browser.html(2));
            return;
            const $mol_browser_ = new $mol_browser;
            const html = $mol_wire_async($mol_browser_.html)("https://google.com");
            console.log(html);
        }
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
//koplenov/rss/rss.node.ts
;
"use strict";
var $;
(function ($) {
    var $$;
    (function ($$) {
        class $koplenov_rss extends $.$koplenov_rss {
            list_items_ids() {
                return ['1', '2'];
            }
            item_title(id) {
        ...
        __decorate([
            $mol_mem
        ], $koplenov_rss.prototype, "list_items_ids", null);
        $$.$koplenov_rss = $koplenov_rss;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
//koplenov/rss/rss.view.ts
