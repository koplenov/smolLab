...
(function ($) {
    ...
    __decorate([
        $mol_mem_key
    ], $koplenov_rss.prototype, "Post", null);
    __decorate([
        $mol_mem
    ], $koplenov_rss.prototype, "Theme", null);
    __decorate([
        $mol_mem
    ], $koplenov_rss.prototype, "query", null);
    __decorate([
        $mol_mem
    ], $koplenov_rss.prototype, "search", null);
    __decorate([
        $mol_mem
    ], $koplenov_rss.prototype, "lighter", null);
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $koplenov_rss.prototype, "proxy", null);
        __decorate([
            $mol_mem_key
        ], $koplenov_rss.prototype, "raw_xml_posts", null);
        __decorate([
            $mol_mem_key
        ], $koplenov_rss.prototype, "posts", null);
        __decorate([
            $mol_mem
        ], $koplenov_rss.prototype, "all_posts", null);
        $$.$koplenov_rss = $koplenov_rss;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
